Voici la traduction en français des règles de validation fournies dans votre code Laravel :
...
return [
    ...
    */
    ...
    | la convention "nom_attribut.regler" pour nommer les lignes. Cela nous permet de
    ...
    */
    ...
    'custom' => [
        'nom_attribut' => [
            'regle_attribut' => 'message_personnalise',
        ],
    ],
